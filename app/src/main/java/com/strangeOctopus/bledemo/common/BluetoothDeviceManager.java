package com.strangeOctopus.bledemo.common;
...
import com.strangeoctopus.blehelper.core.DeviceMirrorPool;
...
import com.strangeOctopus.bledemo.event.CallbackDataEvent;
import com.strangeOctopus.bledemo.event.ConnectEvent;
import com.strangeOctopus.bledemo.event.NotifyDataEvent;
import com.strangeOctopus.bledemo.event.ScanEvent;
...
public class BluetoothDeviceManager {
    ...
    public void init(Context context) {
        ...
        //蓝牙相关配置修改
        ViseBle.config()
                .setScanTimeout(-1)//扫描超时时间，这里设置为永久扫描 -1
