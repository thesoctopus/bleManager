...
public class HexUtil {
    ...
    /**
     * 将App通用的mac地址格式“aabbccdd”
     * 转变为系统底层蓝牙通信用的格式“AA:BB:CC:DD”（冒号间隔的大写字母）
     *
     * @param mac
     */
    public static String upperToBottom(String mac){
        ...
        for(int i = 0; i < size - 2; i+=2){
            ...
            builder.append(mac.charAt(i+1));
            builder.append(":");
        }
        builder.append(mac.charAt(size - 2));
        builder.append(mac.charAt(size - 1));

        return builder.toString().toUpperCase();
    }

    /**
     * 将系统底层蓝牙通信用的mac地址格式“AA:BB:CC:DD”
     * 转变为App通用的格式“aabbccdd”（没有间隔符的小写字母）
     *
     * @param mac
     * @return
     */
    public static String bottomToUpper(String mac){
        if(mac == null) return null;
