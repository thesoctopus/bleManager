...
import com.strangeoctopus.blehelper.callback.IBleCallback;
import com.strangeoctopus.blehelper.callback.IConnectCallback;
import com.strangeoctopus.blehelper.callback.IRssiCallback;
import com.strangeoctopus.blehelper.common.BleConfig;
import com.strangeoctopus.blehelper.common.BleConstant;
import com.strangeoctopus.blehelper.common.ConnectState;
import com.strangeoctopus.blehelper.common.PropertyType;
...
import static com.strangeoctopus.blehelper.common.BleConstant.MSG_CONNECT_RETRY;
import static com.strangeoctopus.blehelper.common.BleConstant.MSG_CONNECT_TIMEOUT;
import static com.strangeoctopus.blehelper.common.BleConstant.MSG_READ_DATA_RETRY;
import static com.strangeoctopus.blehelper.common.BleConstant.MSG_READ_DATA_TIMEOUT;
import static com.strangeoctopus.blehelper.common.BleConstant.MSG_RECEIVE_DATA_RETRY;
import static com.strangeoctopus.blehelper.common.BleConstant.MSG_RECEIVE_DATA_TIMEOUT;
import static com.strangeoctopus.blehelper.common.BleConstant.MSG_WRITE_DATA_RETRY;
import static com.strangeoctopus.blehelper.common.BleConstant.MSG_WRITE_DATA_TIMEOUT;
    ...
    private synchronized void connect() {
        ...
        if (bluetoothLeDevice != null && bluetoothLeDevice.getDevice() != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                bluetoothLeDevice.getDevice().connectGatt(ViseBle.getInstance().getContext(), false, coreGattCallback,TRANSPORT_LE);
            } else {
